...
adata = ad.read_h5ad('/filepath/raw_sc_data.h5ad')
...
### removing low confidence cell calls ---
...
### more cell filtering based on UMAP ---
...
#SAVE 
adata_filtered.write('/filepath/adata_highconf_filtered.h5ad')
